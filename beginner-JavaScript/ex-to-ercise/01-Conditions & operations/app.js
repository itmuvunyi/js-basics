...
if(temp < 20){
    alert(`Hi ${user}, today the temperature ${temp} is cold`);
}else if(temp >= 20 && temp < 30){
    alert(`Hi ${user}, today the temperature ${temp} is warm`);
}else if(temp === 30){
    alert(`Hi ${user}, today the temperature ${temp} is Hot`);
}else{
    alert('Extremely hot');
}